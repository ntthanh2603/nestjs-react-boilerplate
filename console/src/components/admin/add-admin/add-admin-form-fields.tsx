...
import type { AddAdminFormValues } from "@/hooks/members/use-add-admin";

interface AddAdminFormFieldsProps {
  control: Control<AddAdminFormValues>;
}

export const AddAdminFormFields = ({ control }: AddAdminFormFieldsProps) => {
  return (
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="Thông tin thêm về quản trị viên"
                  {...field}
                />
              </FormControl>
              <FormMessage />
