...
import { navigationMemberData } from "@/components/member/layouts/navigation-member";
...
export default function LayoutMember() {
  ...
  return (
    <SidebarProvider>
      <AppSidebar navItems={navigationMemberData} />
      <SidebarInset>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink asChild>
                    <Link className="font-semibold" to={currentRoute.pathname}>
                      {formatLabel(currentRoute.pathname, navigationMemberData)}
                    </Link>
                  </BreadcrumbLink>
                </BreadcrumbItem>
              </BreadcrumbList>
